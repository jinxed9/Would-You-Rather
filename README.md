Intro:
This is my Would You Rather project for the Udacity React Nanodegree program. 

The project should install and run with the "npm install" and "yarn start" commands. 
